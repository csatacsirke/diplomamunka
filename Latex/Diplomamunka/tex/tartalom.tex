...
\begin{itemize}
	\item 
	Tényleges pozitív (\textit{true positive, tp}): Ha egy eredeti mintát megfelelően osztályoztunk.
	
	\item 
	Tényleges negatív (\textit{true negative, tn}): Ha egy hamis mintát megfelelően osztályoztunk.

	\item 
	Fals pozitív / Elsőfajú hiba (\textit{fp}): Ha egy hamis mintát eredetinek osztályozunk.
	
	\item 
	Fals negatív / Másodfajú hiba (\textit{fn}): Ha egy eredeti mintát hamisnak osztályozunk.
	...
	A kétféle hiba arányát a Vevő működési karakterisztika \cite{rocanalysis} (\textit{Receiver operating characteristic}) görbével szoktuk jellemezni. A két tengelyen az egyes hibák rátája található, és azt mutatja meg, hogy egy adott nagyságú elsőfajú hiba-rátához mekkora másodfajú tartozik. ROC-görbére a \ref{fig:roc.pelda}. ábrán láthatunk példát.
	
	A ROC-görbe alatti terület azt mutatja meg, hogy mennyire jól szeparálható a két adathalmaz. 
