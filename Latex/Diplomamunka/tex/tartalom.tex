...
Egy mély háló modellje egy többszörösen összetett függvény, melynek függvényei a rétegek. Ezek paraméteres leképezések, melyek paramétereit gradiens módszerrel számoljuk. Általánosan, egy $ K $ rétegű modell a következőképpen írható fel:
...
Bináris esetben $ \underline{y}=(0, 1) $ ha a minta az egyik, és
...
ezért bevezetünk egy harmadik halmazt, a \textit{teszt halmazt}. Ennek célja, hogy ellenőrizni
tudjuk a modell helyességét a hiperparaméterek véglegesítése után.
