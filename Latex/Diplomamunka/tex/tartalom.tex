...
\begin{itemize}
	...
	\item 
	Fals pozitív / Elsőfajú hiba (\textit{fp}): Ha egy negatív mintát pozitív osztályozunk.
	
	\item 
	Fals negatív / Másodfajú hiba (\textit{fn}): Ha egy pozitív mintát negatívnak osztályozunk.
