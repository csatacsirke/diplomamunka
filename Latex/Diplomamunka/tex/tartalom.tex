...
\begin{itemize}
	...
	\[  l(\underline{\hat{y}}, \underline{y}) = \frac{1}{2 \dim{(\underline{y})}} \norm{\underline{\hat{y}} - \underline{y}}_2^2  . \]
...
%	Akkor célszerű használni, ha tudjuk, hogy az eredmény nem lesz tökéletes, de szeretnénk mérni hibát. Az autoencodernél ezt használjuk.
	...
	ahol $ \underline{y} $ egy olyan bináris vektor, amiben pontosan egy darab $ 1 $-es van, a többi komponense $ 0 $. Ezt osztályozási feladatoknál használjuk, ahol az $ 1 $-es index jelöli az adott minta osztályát.
...
\subsubsection{További kapcsolódó fogalmak}
