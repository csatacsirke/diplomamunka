...
Legtipikusabb a \textit{max pooling} réteg, ami a négy pixel maximumát veszi.
...
Az autoencoder egy olyan speciális háló, amelynél a cél, hogy 
...
Legyen $ y = (0, 0, \dots 1 \dots 0, 0)^T, $ 
