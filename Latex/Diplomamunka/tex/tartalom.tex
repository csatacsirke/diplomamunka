...
Ekkor $ k $, illetve $ K $ a konvolúció kernelje. Ez képeknél egy $ n \times m $ dimenziós mátrix, ahol általában a dimenziók páratlanok, és sokszor $ n = m $ .


Konvolúciós hálóknál több ilyen kernelt rendelünk egy-egy réteghez.
Iterációnként minden egyes kernellel konvolváljuk a bemeneti képeinket, majd azokat a csatorna dimenzió mentén összegezzük.
Tanításnál ezeket az kerneleket javítjuk minden iterációban.
% TODO
