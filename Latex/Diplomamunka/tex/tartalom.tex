...
Azt a periódus, ami alatt a teljes tanító halmaz egyszer feldolgozásra kerül, \textit{epoch}-nak hívjuk.
...
%\paragraph{Megállás}
\subsubsubsection{Korai megállás}
...
Azonban könnyen előfordulhat, hogy az ugyan még egyre kisebb, a validációs hiba viszont el kezd nőni! Ilyenkor biztosak lehetünk benne, hogy a modell elkezdett túltanulni, ezért leállítjuk az optimalizációt (\textit{early-stopping}) \cite{earlystopping}.
